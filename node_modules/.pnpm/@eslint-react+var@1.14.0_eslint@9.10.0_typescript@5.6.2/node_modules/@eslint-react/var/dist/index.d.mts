...
import { Scope, Variable, ScopeManager, Definition } from '@typescript-eslint/scope-manager';
 ...
 */
declare function getVariableDef(at: number): (variable: Variable) => O.Option<Definition>;
 ...
 */
declare function isNodeValueEqual(a: TSESTree.Node, b: TSESTree.Node, initialScopes: [Scope, Scope]): boolean;
