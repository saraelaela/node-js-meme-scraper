...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Data.js
var Data_exports = {};
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Function.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/version.js
var moduleVersion = "3.7.2";
var getCurrentVersion = () => moduleVersion;

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/GlobalValue.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/errors.js
var getBugErrorMessage = (message) => `BUG: ${message} - please report an issue at https://github.com/Effect-TS/effect/issues`;

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Predicate.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Utils.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Either.js
var Either_exports = {};
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Equivalence.js
var make = (isEquivalent) => (self, that) => self === that || isEquivalent(self, that);

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/doNotation.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Equal.js
var Equal_exports = {};
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Hash.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Inspectable.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Pipeable.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/opCodes/effect.js
var OP_COMMIT = "Commit";
var OP_FAILURE = "Failure";
var OP_SYNC = "Sync";
var OP_WITH_RUNTIME = "WithRuntime";

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/effectable.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/option.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/either.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Option.js
var Option_exports = {};
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Order.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Array.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Chunk.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/context.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Context.js
var GenericTag = makeGenericTag;
var empty3 = empty2;

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/hashMap/config.js
var SIZE = 5;
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/hashMap/bitwise.js
function popcount(x) {
  x -= x >> 1 & 1431655765;
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/stack.js
var make5 = (value, previous) => ({
  value,
  previous
});

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/hashMap/array.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/hashMap/node.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/hashMap.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/hashSet.js
...
var _empty4 = /* @__PURE__ */ makeImpl2(/* @__PURE__ */ empty4());
var empty5 = () => _empty4;
...
var add2 = /* @__PURE__ */ dual(2, (self, value) => self._keyMap._editable ? (set(value, true)(self._keyMap), self) : makeImpl2(set(value, true)(self._keyMap)));
var union2 = /* @__PURE__ */ dual(2, (self, that) => mutate(empty5(), (set5) => {
  forEach2(self, (value) => add2(set5, value));
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/HashSet.js
var empty6 = empty5;
var size3 = size2;
var add3 = add2;
var union3 = union2;

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/MutableRef.js
...
var getAndUpdate = /* @__PURE__ */ dual(2, (self, f) => getAndSet(self, f(get2(self))));
...
var update = /* @__PURE__ */ dual(2, (self, f) => set2(self, f(get2(self))));
var updateAndGet = /* @__PURE__ */ dual(2, (self, f) => setAndGet(self, f(get2(self))));
var toggle2 = (self) => update(self, (_) => !_);

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/data.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/differ/contextPatch.js
  ...
  for (const [tag, newService] of newValue.unsafeMap.entries()) {
    if (missingServices.has(tag)) {
      ...
      if (!equals(old, newService)) {
        patch2 = combine2(makeUpdateService(tag, () => newService))(patch2);
      }
    } else {
      missingServices.delete(tag);
      patch2 = combine2(makeAddService(tag, newService))(patch2);
    }
  }
  for (const [tag] of missingServices.entries()) {
    patch2 = combine2(makeRemoveService(tag))(patch2);
  }
  return patch2;
};
...
var patch = /* @__PURE__ */ dual(2, (self, context) => {
  ...
  while (isNonEmpty(patches)) {
    ...
    switch (head2._tag) {
      ...
      case "AndThen": {
        patches = prepend(prepend(tail, head2.second), head2.first);
        break;
      }
      case "RemoveService": {
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/differ.js
...
var environment = () => make8({
  empty: empty7(),
  combine: (first, second) => combine2(second)(first),
  diff: (oldValue, newValue) => diff(oldValue, newValue),
  patch: (patch2, oldValue) => patch(oldValue)(patch2)
});

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/opCodes/cause.js
var OP_DIE = "Die";
var OP_EMPTY = "Empty";
var OP_FAIL = "Fail";
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/cause.js
...
var causeEquals = (left3, right3) => {
  ...
  while (isNonEmpty(leftStack) && isNonEmpty(rightStack)) {
    const [leftParallel, leftSequential] = pipe(headNonEmpty(leftStack), reduce4([empty6(), empty()], ([parallel2, sequential2], cause) => {
      const [par, seq] = evaluateCause(cause);
      return some3([pipe(parallel2, union3(par)), pipe(sequential2, appendAll(seq))]);
    }));
    const [rightParallel, rightSequential] = pipe(headNonEmpty(rightStack), reduce4([empty6(), empty()], ([parallel2, sequential2], cause) => {
      const [par, seq] = evaluateCause(cause);
      return some3([pipe(parallel2, union3(par)), pipe(sequential2, appendAll(seq))]);
    }));
...
var flattenCauseLoop = (causes, flattened) => {
  while (1) {
    const [parallel2, sequential2] = pipe(causes, reduce([empty6(), empty()], ([parallel3, sequential3], cause) => {
      const [par, seq] = evaluateCause(cause);
...
var evaluateCause = (self) => {
  ...
  while (cause !== void 0) {
    switch (cause._tag) {
      ...
      case OP_FAIL: {
        _parallel = add3(_parallel, make3(cause._tag, cause.error));
        if (stack.length === 0) {
          return [_parallel, _sequential];
        }
        cause = stack.pop();
      ...
      case OP_DIE: {
        _parallel = add3(_parallel, make3(cause._tag, cause.defect));
        if (stack.length === 0) {
          return [_parallel, _sequential];
        }
        cause = stack.pop();
      ...
      case OP_INTERRUPT: {
        _parallel = add3(_parallel, make3(cause._tag, cause.fiberId));
        if (stack.length === 0) {
          return [_parallel, _sequential];
        }
        cause = stack.pop();
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/singleShotGen.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/tracer.js
var spanTag = /* @__PURE__ */ GenericTag("effect/ParentSpan");

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/core.js
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Ref.js
var Ref_exports = {};
...
// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/Readable.js
var TypeId8 = /* @__PURE__ */ Symbol.for("effect/Readable");

// ../../node_modules/.pnpm/effect@3.7.2/node_modules/effect/dist/esm/internal/ref.js
...
var RefImpl = class {
  ...
  constructor(ref) {
    ...
    this.get = sync(() => get2(this.ref));
  }
  get;
  modify(f) {
    return sync(() => {
      const current = get2(this.ref);
      const [b, a] = f(current);
      if (current !== a) {
        set2(a)(this.ref);
      }
...
var unsafeMake = (value) => new RefImpl(make7(value));
var make10 = (value) => sync(() => unsafeMake(value));
var get3 = (self) => self.get;
...
export { Data_exports as Data, Either_exports as E, Equal_exports as Equal, Function_exports as F, MutableRef_exports as MutRef, Option_exports as O, Ref_exports as Ref, all, and, asConst, compose2 as compose, entries, eqv, every, fromEntries, hasProperty, implies, isBigInt, isBoolean, isDate, isError, isFunction2 as isFunction, isIterable, isMap, isNever, isNotNull, isNotNullable, isNotUndefined, isNull, isNullable, isNumber, isObject, isPromise, isPromiseLike, isReadonlyRecord, isRecord, isSet, isString, isSymbol, isTagged, isTruthy, isTupleOf, isTupleOfAtLeast, isUint8Array, isUndefined, isUnknown, mapInput, nand, narrow, nor, not, or, product, productMany, some, struct, tuple, typeOf, xor, zip };
